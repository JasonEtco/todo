module.exports = `This issue has been reopened because the **\`{{ keyword }}\`** comment still exists in [**{{ filename }}**](https://github.com/{{ owner }}/{{ repo}}/blob/{{ sha }}/{{ filename }}), as of {{ sha }}.
