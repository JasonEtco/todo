const generateBlob = require('./generate-blob')
 ...
 */
module.exports = function generateBody (config, title, file, contents, author, sha, pr) {
  ...
  const blob = generateBlob(file, contents, sha)
